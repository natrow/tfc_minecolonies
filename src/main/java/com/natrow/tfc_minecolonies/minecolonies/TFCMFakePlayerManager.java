...
public class TFCMFakePlayerManager {
   ...
   */
  public static FakePlayer setupFakePlayer(
      @NotNull final Level world,
      @NotNull final BlockPos workerPos,
      @NotNull final ItemStack toolInHand) {
  ...
  /**
   * Fakes mining whilst doing correct tool handling & drops for TFC. Note: incompatible with
   * Minecolonies drops & item damage handling.
   *
   ...
   */
  public static Runnable getToolBreakAction(
      @NotNull final Level world,
      @NotNull final BlockPos blockPos,
      @NotNull final ItemStack tool,
      @NotNull final BlockPos workerPos,
      @NotNull final ICitizenItemHandler citizenItemHandler) {
    return () -> {
